...
/***************************************************************************************************************************************************/
  ...
  //se rompe al preguntar por el cardinal pero el modulo cola anda perfectamente simulando lo mismo que le pasa al heap desde modulo juego , es absurdo
  //??????????????????????????????????????????????????????
  //no pude implementar la funcion recursiva, consultar
  RUN_TEST(test_entrenadores_posibles);

  // a la hora de capturar cuelga por culpa del iterador que se invalida
